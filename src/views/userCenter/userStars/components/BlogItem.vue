<!--  -->
<template>
  <div class="blogItem" @mouseenter="handleMouseEnter" @mouseleave="handleMouseLeave">
    <div class="meta-container">
      ...
      <div class="item-handle">
        <el-button :class="{ 'delete-item': isHiddenDelete }" @click.stop="deleteItem" link>取消收藏</el-button>
      </div>
    </div>
...
const isHiddenDelete = ref<boolean>(true);
...
const handleMouseEnter = () => {
  isHiddenDelete.value = false;

}

const handleMouseLeave = () => {
  isHiddenDelete.value = true;
}
